...
int net_send(const Logger *log, Socket sock, const void *buf, size_t len, IP_Port ip_port)
{
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
...
int net_recv(const Logger *log, Socket sock, void *buf, size_t len, IP_Port ip_port)
{
#ifdef FUZZING_BUILD_MODE_UNSAFE_FOR_PRODUCTION
