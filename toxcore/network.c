...
bool net_check_socket_ip_is_incompatible(const Networking_Core *net, const IP_Port *ip_port)
{
    return net_family_is_ipv4(net->family) && !net_family_is_ipv4(ip_port->ip.family);
}
...
int net_send_packet(const Networking_Core *net, const IP_Port *ip_port, Net_Packet packet)
{
    ...
    if (net_check_socket_ip_is_incompatible(net, ip_port)) {
