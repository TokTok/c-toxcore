...
using SymmetricKey = std::array<uint8_t, CRYPTO_SYMMETRIC_KEY_SIZE>;
...
TEST(CryptoCore, Hmac)
{
    ...
    // TODO(zugz): Is symmetric key the right kind of key for the hmac functions?
    SymmetricKey sk;
    new_symmetric_key(rng, sk.data());
