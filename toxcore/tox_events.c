...
void tox_events_pack(const Tox_Events *events, Bin_Pack *bp)
{
...
static void tox_events_bin_pack_handler(Bin_Pack *bp, const void *obj)
{
    tox_events_pack((const Tox_Events *)obj, bp);
}
