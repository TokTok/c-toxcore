 ...
 * @max_sanctions The maximum number of sanctions that the sanctions array can hold.
 * @data The packed data array.
 * @length The size of the packed data.
 * @processed_data_len If non-null, will contain the number of processed bytes on success.
 *
