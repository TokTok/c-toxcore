...
DHT *onion_get_dht(non_null() const Onion_Client *onion_c);
Net_Crypto *onion_get_net_crypto(non_null() const Onion_Client *onion_c);
 ...
 */
bool onion_add_bs_path_node(non_null() Onion_Client *onion_c, non_null() const IP_Port *ip_port, non_null() const uint8_t *public_key);

/** @brief Put up to max_num nodes in nodes.
 *
 * return the number of nodes.
 */
uint16_t onion_backup_nodes(non_null() const Onion_Client *onion_c, non_null() Node_format *nodes, uint16_t max_num);
 ...
 */
int onion_friend_num(non_null() const Onion_Client *onion_c, non_null() const uint8_t *public_key);
 ...
 */
int onion_addfriend(non_null() Onion_Client *onion_c, non_null() const uint8_t *public_key);
 ...
 */
int onion_delfriend(non_null() Onion_Client *onion_c, int friend_num);
 ...
 * return 0 on success.
 */
int onion_set_friend_online(non_null() Onion_Client *onion_c, int friend_num, bool is_online);
 ...
 */
int onion_getfriendip(non_null() const Onion_Client *onion_c, int friend_num, non_null() IP_Port *ip_port);

typedef int recv_tcp_relay_cb(non_null() void *object, uint32_t number, non_null() const IP_Port *ip_port, non_null() const uint8_t *public_key);
 ...
 * return 0 on success.
 */
int recv_tcp_relay_handler(non_null() Onion_Client *onion_c, int friend_num, non_null() recv_tcp_relay_cb *callback, non_null() void *object, uint32_t number);

typedef void onion_dht_pk_cb(non_null() void *object, int32_t number, non_null() const uint8_t *dht_public_key, nullable() void *userdata);
 ...
 * return 0 on success.
 */
int onion_dht_pk_callback(non_null() Onion_Client *onion_c, int friend_num, non_null() onion_dht_pk_cb *function, non_null() void *object, uint32_t number);
 ...
 * return 0 on success.
 */
int onion_set_friend_dht_pubkey(non_null() Onion_Client *onion_c, int friend_num, non_null() const uint8_t *dht_key);
 ...
 */
unsigned int onion_getfriend_dht_pubkey(non_null() const Onion_Client *onion_c, int friend_num, non_null() uint8_t *dht_key);
 ...
 * return -1 on failure.
 */
int send_onion_data(non_null() Onion_Client *onion_c, int friend_num, non_null() const uint8_t *data, uint16_t length);

typedef int oniondata_handler_cb(nullable() void *object, non_null() const uint8_t *source_pubkey, non_null() const uint8_t *data,
                                 uint16_t length, nullable() void *userdata);

/** Function to call when onion data packet with contents beginning with byte is received. */
void oniondata_registerhandler(non_null() Onion_Client *onion_c, uint8_t byte, nullable() oniondata_handler_cb *cb, nullable() void *object);
typedef bool onion_group_announce_cb(non_null() Onion_Client *onion_c, uint32_t sendback_num, non_null() const uint8_t *data,
                                     size_t data_length, nullable() void *user_data);

/** Function to call when the onion gets a group announce response. */
void onion_group_announce_register(non_null() Onion_Client *onion_c, nullable() onion_group_announce_cb *func, nullable() void *user_data);
void do_onion_client(non_null() Onion_Client *onion_c);

Onion_Client *new_onion_client(non_null() const Logger *logger, non_null() const Memory *mem, non_null() const Random *rng, non_null() const Mono_Time *mono_time, non_null() Net_Crypto *c);

void kill_onion_client(nullable() Onion_Client *onion_c);
...
Onion_Connection_Status onion_connection_status(non_null() const Onion_Client *onion_c);

typedef struct Onion_Friend Onion_Friend;

uint16_t onion_get_friend_count(non_null() const Onion_Client *onion_c);
Onion_Friend *onion_get_friend(non_null() const Onion_Client *onion_c, uint16_t friend_num);
const uint8_t *onion_friend_get_gc_public_key(non_null() const Onion_Friend *onion_friend);
const uint8_t *onion_friend_get_gc_public_key_num(non_null() const Onion_Client *onion_c, uint32_t num);
void onion_friend_set_gc_public_key(non_null() Onion_Friend *onion_friend, non_null() const uint8_t *public_key);
void onion_friend_set_gc_data(non_null() Onion_Friend *onion_friend, nullable() const uint8_t *gc_data, uint16_t gc_data_length);
bool onion_friend_is_groupchat(non_null() const Onion_Friend *onion_friend);
