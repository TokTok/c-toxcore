...
constant(int, ONION_ANNOUNCE_MAX_ENTRIES, 160);
constant(int, ONION_ANNOUNCE_TIMEOUT, 300);
constant(int, ONION_PING_ID_SIZE, TIMED_AUTH_SIZE);
constant(int, ONION_MAX_EXTRA_DATA_SIZE, 136);

constant(int, ONION_ANNOUNCE_SENDBACK_DATA_LENGTH, (sizeof(uint64_t)));

constant(int, MAX_SENT_GC_NODES, 1);
constant(int, ONION_ANNOUNCE_REQUEST_MIN_SIZE, (1 + CRYPTO_NONCE_SIZE + CRYPTO_PUBLIC_KEY_SIZE + ONION_PING_ID_SIZE + CRYPTO_PUBLIC_KEY_SIZE + CRYPTO_PUBLIC_KEY_SIZE + ONION_ANNOUNCE_SENDBACK_DATA_LENGTH + CRYPTO_MAC_SIZE));
constant(int, ONION_ANNOUNCE_REQUEST_MAX_SIZE, (ONION_ANNOUNCE_REQUEST_MIN_SIZE + ONION_MAX_EXTRA_DATA_SIZE));

constant(int, ONION_ANNOUNCE_RESPONSE_MIN_SIZE, (2 + ONION_ANNOUNCE_SENDBACK_DATA_LENGTH + CRYPTO_NONCE_SIZE + ONION_PING_ID_SIZE + CRYPTO_MAC_SIZE));
constant(int, ONION_ANNOUNCE_RESPONSE_MAX_SIZE, (ONION_ANNOUNCE_RESPONSE_MIN_SIZE + ONION_MAX_EXTRA_DATA_SIZE * MAX_SENT_NODES));

/* TODO: DEPRECATE */
constant(int, ONION_ANNOUNCE_REQUEST_SIZE, (1 + CRYPTO_NONCE_SIZE + CRYPTO_PUBLIC_KEY_SIZE + ONION_PING_ID_SIZE + CRYPTO_PUBLIC_KEY_SIZE + CRYPTO_PUBLIC_KEY_SIZE + ONION_ANNOUNCE_SENDBACK_DATA_LENGTH + CRYPTO_MAC_SIZE));

constant(int, ONION_DATA_RESPONSE_MIN_SIZE, (1 + CRYPTO_NONCE_SIZE + CRYPTO_PUBLIC_KEY_SIZE + CRYPTO_MAC_SIZE));

constant(int, ONION_DATA_REQUEST_MIN_SIZE, (1 + CRYPTO_PUBLIC_KEY_SIZE + CRYPTO_NONCE_SIZE + CRYPTO_PUBLIC_KEY_SIZE + CRYPTO_MAC_SIZE));
constant(int, MAX_DATA_REQUEST_SIZE, (ONION_MAX_DATA_SIZE - ONION_DATA_REQUEST_MIN_SIZE));
