...
constant(int, ONION_MAX_PACKET_SIZE, 1400);

constant(int, ONION_RETURN_1, (CRYPTO_NONCE_SIZE + SIZE_IPPORT + CRYPTO_MAC_SIZE));
constant(int, ONION_RETURN_2, (CRYPTO_NONCE_SIZE + SIZE_IPPORT + CRYPTO_MAC_SIZE + ONION_RETURN_1));
constant(int, ONION_RETURN_3, (CRYPTO_NONCE_SIZE + SIZE_IPPORT + CRYPTO_MAC_SIZE + ONION_RETURN_2));

constant(int, ONION_SEND_BASE, (CRYPTO_PUBLIC_KEY_SIZE + SIZE_IPPORT + CRYPTO_MAC_SIZE));
constant(int, ONION_SEND_3, (CRYPTO_NONCE_SIZE + ONION_SEND_BASE + ONION_RETURN_2));
constant(int, ONION_SEND_2, (CRYPTO_NONCE_SIZE + ONION_SEND_BASE*2 + ONION_RETURN_1));
constant(int, ONION_SEND_1, (CRYPTO_NONCE_SIZE + ONION_SEND_BASE*3));

constant(int, ONION_MAX_DATA_SIZE, (ONION_MAX_PACKET_SIZE - (ONION_SEND_1 + 1)));
constant(int, ONION_RESPONSE_MAX_DATA_SIZE, (ONION_MAX_PACKET_SIZE - (1 + ONION_RETURN_3)));

constant(int, ONION_PATH_LENGTH, 3);
