 ...
 * return 0 on success.
 */
int send_onion_packet(const Networking_Core *net, const Onion_Path *path, IP_Port dest, const uint8_t *data, uint16_t length);
 ...
 * return 0 on success.
 */
int send_onion_response(const Networking_Core *net, IP_Port dest, const uint8_t *data, uint16_t length, const uint8_t *ret);
