...
uint8_t *state_write_section_header(non_null() uint8_t *data, uint16_t cookie_type, uint32_t len, uint32_t section_type);
...
void host_to_lendian_bytes64(non_null() uint8_t *dest, uint64_t num);
void lendian_bytes_to_host64(non_null() uint64_t *dest, non_null() const uint8_t *lendian);

void host_to_lendian_bytes32(non_null() uint8_t *dest, uint32_t num);
void lendian_bytes_to_host32(non_null() uint32_t *dest, non_null() const uint8_t *lendian);

void host_to_lendian_bytes16(non_null() uint8_t *dest, uint16_t num);
void lendian_bytes_to_host16(non_null() uint16_t *dest, non_null() const uint8_t *lendian);
