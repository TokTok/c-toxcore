...
bool tox_file_send_chunk(Tox *_Nonnull tox, uint32_t friend_number, uint32_t file_number, uint64_t position, const uint8_t *_Nonnull data,
...
{
    assert(tox != nullptr);    tox_lock(tox);
