...
bool sanctions_list_make_creds(Moderation *moderation)
{
    ...
    if (!sign_detached(moderation->sanctions_creds.sig, nullptr, moderation->sanctions_creds.hash,
...
static bool sanctions_list_sign_entry(const Moderation *moderation, Mod_Sanction *sanction)
{
    ...
    return sign_detached(sanction->signature, nullptr, packed_data, packed_len - SIGNATURE_SIZE,
