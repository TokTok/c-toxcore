...
/** @brief Returns a new group announces list. The caller is responsible for freeing
 * the memory with `kill_gca`.
 */
GC_Announces_List *new_gca_list(void);

/** @brief Frees all dynamically allocated memroy associated with `announces_list`. */
nullable(1)
 ...
 *
 * @param gc_announce_list The list of announces to iterate.
 *
 ...
 *
 * @retval the number of added nodes on success.
 * @retval -1 on failure.
 */
non_null()
 ...
 *
 * @retval the peer announce on success.
 ...
 *
 * @retval the size of the packed data on success.
 * @retval -1 on failure.
 */
non_null()
 ...
 *
 * @param data The data buffer being packed.
 * @param length The size in bytes of the data buffer.
 ...
 *
 * @retval The number of packed announces on success.
 * @retval -1 on failure.
 */
 ...
 *
 * @retval the number of unpacked announces on success.
 * @retval -1 on failure.
 */
non_null()
 ...
 *
 * @retval the size of the unpacked data on success.
 * @retval -1 on failure.
 */
non_null()
