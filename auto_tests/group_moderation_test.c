...
static void voice_state_message_test(AutoTox *autotox, Tox_Group_Voice_State voice_state)
{
    ...
    Tox_Err_Group_Send_Message msg_err = TOX_ERR_GROUP_SEND_MESSAGE_OK;
...
static void group_moderation_test(AutoTox *autotoxes)
{
    ...
    Tox_Err_Group_Mod_Set_Role role_err = TOX_ERR_GROUP_MOD_SET_ROLE_OK;
    ...
    Tox_Err_Group_Mod_Kick_Peer k_err = TOX_ERR_GROUP_MOD_KICK_PEER_OK;
